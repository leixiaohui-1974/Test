...
from hydraulic_model.solvers import HLLMusclSolver
...
def main() -> None:
    parser = build_common_parser("Run the HLL-MUSCL solver workflow.", "outputs/hll_muscl")
    parser.add_argument(
        "--internal-boundaries",
        type=Path,
        default=None,
    ...
    scaling = 0.1 if args.scenario == "pressurised" else 0.25
    dt_hll = min(dt_common * scaling, 1.0)
